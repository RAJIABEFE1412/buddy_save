...
class BuddyFormatter {
  ...
  static DateTime formatStringLong(String date, {String? format}) {
    DateFormat formatter =
        format == null ? DateFormat("d-MM-yyyy hh:mm:ss") : DateFormat(format);
...
class AmountFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    try {
      ...
      if (isValidNum) {
        final formattedText = BuddyFormatter.formatCurrencyInput(amount);
        return TextEditingValue(
          text: formattedText,
